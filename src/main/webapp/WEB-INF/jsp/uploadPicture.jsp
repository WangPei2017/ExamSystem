...
<link href="${pageurl }/js/v2.3/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
...
<div id="dddd" style="background-color:#ccc;width:20px;height:20px;"></div>
...
<script type="text/javascript" src="${pageurl }/js/v2.3/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="${pageurl }/js/v2.3/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="${pageurl }/js/v2.3/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="${pageurl }/js/v2.3/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: '${pageurl }/upload/picture.do',
            // runtimeOrder: 'flash',
        ...
        uploader.on( 'dndAccept', function( items ) {
            ...
            for ( ; i < len; i++ ) {
                // 如果在列表里面
                var ss = unAllowed.indexOf(items[i].type);
